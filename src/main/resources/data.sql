...
INSERT INTO magazines (user_id, is_public, title, subtitle, introduction, cover_image_url, tags, created_at)
SELECT u.id, true, '겨울 패션 트렌드 2025', '따뜻함과 스타일을 동시에', '올 겨울 꼭 알아야 할 패션 트렌드를 소개합니다.',
...
INSERT INTO magazines (user_id, is_public, title, subtitle, introduction, cover_image_url, tags, created_at)
SELECT u.id, true, '서울 카페 투어', '숨겨진 명소를 찾아서', '서울의 감성 카페들을 모아봤습니다.',

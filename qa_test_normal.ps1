...
Test-API -TestId "M-2" -Description "Get My Magazines" `
    -Method "GET" -Endpoint "/magazines/me?page=0&size=10" -Headers $authHeaders
...
if ($magazineId) {
    ...
    Test-API -TestId "M-4" -Description "Update Magazine" `
        -Method "PATCH" -Endpoint "/magazines/$magazineId" -Headers $authHeaders -Body $updateBody
}
...
if ($magazineId) {
    ...
    $visibilityResponse = Test-API -TestId "M-6" -Description "Set Visibility" `
        -Method "PATCH" -Endpoint "/magazines/$magazineId/visibility" -Headers $authHeaders -Body $visibilityBody
...
if ($magazineId) {
    Test-API -TestId "M-9" -Description "Toggle Like" `
        -Method "POST" -Endpoint "/magazines/$magazineId/likes" -Headers $authHeaders
}
